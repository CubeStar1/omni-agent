"""
Test data for National Parivar Mediclaim Plus Policy
- Comprehensive insurance policy test with 10 questions
- Focuses on grace periods, waiting periods, coverage details
"""

TEST_DATA = {
    "name": "Isaac Newton's Principia Mathematica Test",
    "description": "Comprehensive test for Isaac Newton's Principia Mathematica",
